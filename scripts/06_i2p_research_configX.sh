...
echo "[1/5] Stopping I2P for configuration..."
systemctl stop i2p.service

echo "[2/5] Waiting for I2P to fully stop..."
sleep 3

echo "[3/5] Applying research configuration..."
...
echo "[5/5] Starting I2P with research configuration..."
