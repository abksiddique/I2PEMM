...
<p align="center">
  <img src="data/Framework-CloudSWARM.drawio.pdf" alt="SWARM-I2P Framework Overview" width="100%">
</p>
...
| ------------------------------------------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------------------- | ------------------------------------------------------------------------------- |
| **Fig. 2 — Client (Tunnel Nodes)**         | Selection and Cluster                                       | `Client-Tunnel.csv                                   | `notebooks/I2P_Client_Tunnel_Node_Visualization.ipynb`          | `docs/figures/fig2_client_tunnel_nodes.png` |
| **Fig. 4 — Exploratory (Tunnel)**         | Selection frequency & time trend                                      | `Exploratory Tunnel-merged.txt                                   | `notebooks/Exploratory_Tunnels.ipynb`          | `docs/figures/fig4_Exploratorytunnel.jpg` |
